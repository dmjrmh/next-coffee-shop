...
import { footerConstant, } from "@/constants/text"; 

const navLinks = [
  { href: "/", label: footerConstant.HOME },
  { href: "/menu", label: footerConstant.MENU },
  { href: "/rewards", label: footerConstant.REWARDS },
  { href: "/location", label: footerConstant.STORE_LOCATOR },
];
        ...
        <div className="grid grid-cols-1 gap-8 py-10 sm:grid-cols-2 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-stone-700">
              <li>
                <a href={`tel:${footerConstant.TEL}`} className="hover:underline">
                  {footerConstant.TEL}
                </a>
              </li>
              <li>
                <a href="mailto:info@coffeeshop.com" className="hover:underline">
                  {footerConstant.EMAIL}
                </a>
              </li>
              <li>{footerConstant.LOCATION}</li>
            </ul>
          </div>
